...
const Features = ({name, height, diameter, mass, payload_weights: payloadWeights, descripton}) => {
			...
			<table className="table">
				...
				<thead>
					...
					<tr>
						...
						<td className="table-column">{mass.kg} kg / {mass.lb}</td>
					</tr>
